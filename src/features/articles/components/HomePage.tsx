...
export function HomePage(): React.ReactNode {
  ...
  return (
    <main id="main-content">
      ...
      <section
        aria-label="Hero"
        className="bg-gradient-to-br from-green-50 via-paper to-tan-50 pt-14 pb-12 relative overflow-hidden"
      >
        <div className="max-w-[1100px] mx-auto px-5">
          <div className="grid grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-1.5 bg-white border border-green-100 rounded-full px-3 py-1.5 text-[11px] font-bold text-green-600 tracking-[0.06em] uppercase mb-4">
                <span className="w-1.5 h-1.5 bg-green-500 rounded-full animate-pulse-dot shrink-0" />
                🌿 Evidence-based · Expert-verified
              </div>

              <h1 className="font-serif text-[clamp(28px,4vw,50px)] font-black leading-[1.08] text-ink tracking-[-0.04em] mb-4">
                Science-backed
                <br />
              ...
              <p className="text-base text-ink-3 leading-[1.75] mb-6 max-w-[480px] font-light">
                Expert-verified articles, AI-powered insights, and curated podcasts — designed to
                help you live healthier, not just longer.
              </p>

              <div className="flex items-center bg-white border-2 border-border rounded-full py-1.5 pl-4 pr-1.5 shadow-[0_4px_20px_rgba(19,25,23,0.09)] max-w-[520px] mb-3">
                ...
                <input
                  id="hero-search"
                  placeholder='Ask: "how to improve sleep" or "stress relief"'
                  className="flex-1 border-none bg-transparent text-sm text-ink min-w-0 py-1 outline-none"
                  onKeyDown={(e) => e.key === 'Enter' && navigate('/ai')}
                />
                <button
                  onClick={() => navigate('/ai')}
                  className="bg-green-500 text-white rounded-full px-4 py-2.5 text-xs font-semibold border-none hover:bg-green-600 transition-colors shrink-0 whitespace-nowrap"
                >
                  Ask Vita AI
                </button>
              </div>
            ...
            <div className="relative h-[400px]" aria-hidden="true">
              <div className="absolute top-0 left-0 right-10 bg-white rounded-2xl overflow-hidden shadow-[0_10px_40px_rgba(19,25,23,0.12)] border border-border">
                <img
                  src={articles[0]?.imageUrl ?? 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=500&q=80'}
                  alt=""
                ...
                <div className="p-4">
                  ...
                  <p className="font-serif text-sm font-bold text-ink leading-snug mb-1.5">
              ...
              <div className="absolute top-3 right-0 bg-green-600 text-white rounded-xl p-3 shadow-[0_8px_28px_rgba(19,25,23,0.14)] w-[158px] animate-float">
              ...
              {streak > 0 && (
                <div className="absolute bottom-5 right-0 bg-white rounded-xl p-3 shadow-[0_8px_28px_rgba(19,25,23,0.1)] border border-border w-[150px] animate-float-delayed">
                  <p className="text-[9px] font-bold tracking-[0.08em] uppercase text-tan-400 mb-1">
                    🔥 Streak
                  </p>
                  <p className="font-serif text-[26px] font-black text-tan-600 leading-none">
                    {streak}
                  </p>
                  ...
                  <div className="flex gap-0.5 mt-2">
                    {STREAK_DAYS.map((d, i) => (
                      <div
                        key={i}
                        className="w-[17px] h-[17px] rounded-full text-[7px] font-bold flex items-center justify-center"
                        style={{
      ...
      {/* ── Trust Bar ── */}
      <div className="bg-white border-t border-b border-border py-3" role="region" aria-label="Trust indicators">
        <div className="max-w-[1100px] mx-auto px-5 flex gap-5 items-center justify-center flex-wrap">
      ...
      {/* ── Articles Section ── */}
      <section className="py-16 bg-paper" aria-label="Latest articles">
        <div className="max-w-[1100px] mx-auto px-5">
          <SectionHeader
          ...
          {articlesQuery.isLoading ? (
            ...
            <>
              <div
                className="grid mb-3.5 rounded-2xl overflow-hidden"
                style={{ gridTemplateColumns: '1.7fr 1fr', gap: '1px', background: '#E4EDE7' }}
              >
                <ArticleCard article={articles[0]} size="xl" />
                {(articles[1] || articles[2]) && (
                  <div className="grid" style={{ gap: '1px', background: '#E4EDE7' }}>
      ...
      {/* ── AI Section ── */}
      <section className="bg-ink py-14 relative overflow-hidden" aria-label="AI Health Assistant">
        <div className="max-w-[1100px] mx-auto px-5 relative z-10">
          <div className="grid grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="font-serif text-[clamp(22px,3vw,38px)] font-black text-white tracking-tight leading-tight mb-3.5">
                Meet <em className="text-green-400 font-light not-italic">Vita</em> — your personal
                wellness intelligence
              </h2>
              <p className="text-sm text-white/55 leading-relaxed mb-5 font-light">
              ...
              <div className="mb-6">
                {[
                  ...
                  <div key={title} className="flex gap-2.5 items-start mb-3">
              ...
              <div className="flex gap-2.5 flex-wrap">
                <button
                  onClick={() => navigate('/ai')}
                  className="bg-green-500 text-white rounded-full px-5 py-2.5 text-xs font-semibold border-none hover:bg-green-400 transition-colors"
                >
                  Open Full AI Chat →
                </button>
      ...
      {/* ── Daily Tips ── */}
      <section
        className="py-16 bg-gradient-to-br from-green-50 via-paper to-tan-50"
          ...
          {tipsQuery.isLoading ? (
            ...
            <div className="grid grid-cols-4 gap-3">
              {tips.map((tip) => (
                <div
                  key={tip.id}
                  className="bg-white rounded-2xl p-5 border border-border hover:shadow-md transition-shadow cursor-pointer"
                >
                  <div
                  ...
                  <p className="text-xs text-ink-3 leading-relaxed font-light">{tip.text}</p>
      ...
      {/* ── Experts ── */}
      <section
        className="py-16 bg-green-50 border-t border-b border-green-100"
