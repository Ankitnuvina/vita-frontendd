...
import { Eye, EyeOff, UserKey, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-paper flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-[400px]">
        ...
        >
          <span aria-hidden="true"><ArrowLeft className='h-4 w-4'/></span> Back to Vitalize
        </Link>
        ...
        <div className="bg-white border border-border rounded-2xl shadow-sm p-8">
          ...
          <form onSubmit={(e) => void handleSubmit(e)} noValidate>
            ...
            <button
              ...
              className="w-full bg-[#1E6E3A] text-white rounded-xl py-2.5 text-sm font-semibold hover:bg-[#1E6E3A] transition-colors disabled:opacity-50 disabled:cursor-not-allowed border-none cursor-pointer"
            >
